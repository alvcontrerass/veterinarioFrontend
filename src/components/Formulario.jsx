		...
		<>
			...
			>
				<div className="mb-5">
					<label
						htmlFor="nombre"
						className="mb-5 text-gray-700 uppercase font-bold"
					>
						Nombre Mascota
						<input
							id="nombre"
							...
							className="border-1 border-gray-300 w-full p-2 mt-2 placeholder-gray-400 rounded-md focus:outline-indigo-500 focus:outline-2 focus:border-0"
						/>
					</label>
				</div>
				<div className="mb-5">
				...
				<div className="mb-5">
					...
					>
						...
						<textarea
							id="sintomas"
							placeholder="Cansancio, +12 horas sin comer, agresivo, etc."
							value={sintomas}
